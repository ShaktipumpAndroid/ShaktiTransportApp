...
public class OfficerAssignedDeliveryAdapter  extends ArrayAdapter<OfficerAssignedDeliveryResponse> {

    Context context;
    public ArrayList<OfficerAssignedDeliveryResponse> arrayList;
    private List<OfficerAssignedDeliveryResponse> SearchesList = null;

    public OfficerAssignedDeliveryAdapter(Context context, ArrayList<OfficerAssignedDeliveryResponse> arrayList) {
        super(context, R.layout.partial_load_item_view, arrayList);
        this.context = context;
        this.arrayList = arrayList;
        this.SearchesList = new ArrayList<OfficerAssignedDeliveryResponse>();
    ...
    @Override
    public OfficerAssignedDeliveryResponse getItem(int position) {
    ...
    public View getView(final int position, View view, final ViewGroup parent) {
        OfficerAssignedDeliveryResponse partialLoadResponse = getItem(position);
        if (view == null) {
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (OfficerAssignedDeliveryResponse cs : SearchesList) {
